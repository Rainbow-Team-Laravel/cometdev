...
@section('main-content')
  ...
  {{--@php--}}
    ...
    {{--echo "<pre>";--}}
    {{--//print_r($slider);                                    //to fetch all row values  from  `home_pages`  table--}}
    {{--echo "</pre>";--}}
  ...
  {{--@endphp--}}
    ...
    @php
    $slider = App\Models\HomePage::find(1);                  //got all sliders
    $slider_content = json_decode($slider->sliders);         //table column name is sliders

    $all_data = App\Models\Testimonial::all();               // print_r($all_data);
    ...
    <div class="section-content pb-0">
      <div id="works" class="four-col wide mt-50">
        ...
        <div class="work-item graphic printing">
          <div class="work-detail">
            <a href="portfolio-single-1.html">
              <img style="width: 400px; height: 400px" src="{{URL::to('/')}}/media/testimonials/{{$data->testimonial_img}}" alt="">
              <div class="work-info">
                <div class="centrize">
                  <div class="v-center">
                    <h3>{{$data->title}}</h3>
