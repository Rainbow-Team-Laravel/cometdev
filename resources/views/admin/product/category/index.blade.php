            ...
            <!-- /Page Header -->
             ...
             <div class="row">
                 <div class="col-lg-12">
                     @include('validate')
                     {{--@if($errors ->any())--}}
                        {{--<p class="alert alert-dander">{{$errors -> first()}} <button data-dismiss="alert" class="close">&times;</button> </p>--}}
                         {{--@endif--}}
                     ...
                     <button class="btn btn-sm btn-primary" href="#category_modal"  data-toggle="modal">Add New Category(Product)</button>
                     <br>
                     <br>
                     <div class="card">
                         <div class="card-header">
                             <h4 class="card-title">All Categories-Product</h4>
                         </div>
                         <div class="card-body">
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">Add New Category(Product)</h4>
                            <button class="close" data-dismiss="modal">&times;</button>
                        </div>
                        <div class="modal-body">

                            {{--{{'Through Modal we getting form and we can send data by using store method '}}--}}
