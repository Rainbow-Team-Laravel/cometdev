...
@section('main-content')
    ...
    @php
         ...
         // echo 'ID :'.$single_id;
          ...
          $slider = App\Models\SliderPost::find($single_id);                  //got all sliders
         ...
         // echo $slider->sliders;
           ...
           /* echo "<pre>";
            print_r($slider->sliders);
           echo "</pre>";
           */


          echo $slider->featured_image;

          $slider_content = json_decode($slider->sliders);      //print_r($slider_content);   //table column name is sliders and value will show as json
         /* echo "<pre>";
          print_r($slider_content);
          echo "</pre>"; */
